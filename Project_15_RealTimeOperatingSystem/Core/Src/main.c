...
/* USER CODE BEGIN PFP */
void Task3_Init (void const *argment);
...
{
	uint8_t data[] = "Deftask";
	HAL_UART_Transmit(&huart2,data,sizeof(data),500);
}

void send_task_02 (void)
{
	uint8_t data[] = "Tarefa 02";
	HAL_UART_Transmit(&huart2,data,sizeof(data),500);
}

void send_task_03 (void)
{
	uint8_t data[] = "Tarefa 03";
	HAL_UART_Transmit(&huart2,data,sizeof(data),500);
}
