...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //value  = (9*value)/5 + 32;
	  //Convertion to ºC to F


	  sprintf(msg,"\n\n%f\n\n",value);
	  //Put on a buffer a value that is pass
	  //Couses the double variable value to be converted to a string with
	  // return and line feed concatenated to the value.
